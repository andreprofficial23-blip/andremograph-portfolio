...
import { PROJECTS, DICT, Language, Project } from "./lib/config";
...
export default function PortfolioPage() {
  ...
  return (
    <div className="min-h-screen bg-[#050506] text-white selection:bg-[#C5A059]/30 font-sans overflow-x-hidden">
      {/* HEADER / NAVIGATION */}
      <nav className="fixed top-0 w-full px-8 py-6 flex justify-between items-center z-[100] backdrop-blur-md">
        ...
        <div className="flex items-center gap-8">
           <button 
             ...
             className="text-[10px] font-bold tracking-widest uppercase hover:text-[#C5A059] transition-colors"
           >
             {t.lang_name}
           </button>
           <a 
             href="mailto:hello@andremograph.com" 
             className="bg-white text-black px-5 py-2 rounded-full text-[10px] font-bold tracking-widest uppercase hover:bg-[#C5A059] transition-all"
           >
             {t.section_contact}
           </a>
        </div>
           ...
           <div className="grid md:grid-cols-2 gap-24">
              ...
              <div className="flex flex-col justify-end">
                ...
                <div className="flex flex-wrap gap-8">
                  <a href="https://instagram.com/andremograph" target="_blank" className="group flex items-center gap-2 text-[11px] tracking-widest uppercase font-bold">
