...
const VIDEOS: Video[] = [
  { id: "v1", title: "Live Capture 01", type: "Longo", youtubeId: "LO9EnykVlBg" },
  { id: "v2", title: "Audio Interface", type: "Longo", youtubeId: "ISM8v6E5Yso" },
  { id: "v3", title: "OS Environment", type: "Longo", youtubeId: "oK1p72YO2pw" },
  { id: "v4", title: "World Finals Comp", type: "Longo", youtubeId: "M0OcyKCJhYs" },
  { id: "v5", title: "Currency Dynamics", type: "Longo", youtubeId: "q7jkRt0XXPY" },
  { id: "v6", title: "Project One", type: "Curto", youtubeId: "xpYasagUJAs" },
  { id: "v7", title: "Project Two", type: "Curto", youtubeId: "u98UHtQWVNA" },
  { id: "v8", title: "Project Three", type: "Curto", youtubeId: "n2OiJBRhzOU" },
  { id: "v9", title: "Project Four", type: "Curto", youtubeId: "LK1cKH6xJvY" },
  { id: "v10", title: "Project Five", type: "Curto", youtubeId: "AKuQB0DLdoY" },
  { id: "v11", title: "Project Six", type: "Curto", youtubeId: "JeLV_HljZas" },
  { id: "v12", title: "Project Seven", type: "Curto", youtubeId: "3KPQzNRwH9Q" }
];
        ...
        <main className="w-full max-w-[1200px] mx-auto px-6">
          ...
          <section className="min-h-screen flex flex-col justify-center pt-32 pb-10">
            <div className="flex flex-col md:flex-row items-center gap-16 md:gap-24">
              ...
              >
                <span className="text-[#C5A059] text-[10px] uppercase tracking-wide font-bold mb-6 block">Maceió, AL</span>
          ...
          <section id="contact" className="py-40 w-full border-t border-white/10 flex flex-col items-center text-center">
            <motion.div initial="hidden" whileInView="visible" viewport={{ once: true }} variants={fadeUp}>
              ...
              <div className="flex flex-col md:flex-row gap-8 justify-center items-center mt-12">
                ...
                <a href="https://instagram.com/andremograph" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-transparent border border-white/20 text-white rounded-full text-xs uppercase tracking-widest font-bold hover:border-[#C5A059] hover:text-[#C5A059] transition-colors">
                  Instagram
                </a>
              </div>
            </motion.div>
